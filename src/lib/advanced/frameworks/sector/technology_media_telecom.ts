...
export const technologyMediaTelecomSectorFramework = {
  analyticalQuestions: [
    "What are the primary value pools and share-shift dynamics in technology media telecom?",
  ...
  regulatoryWatchouts: [
    "Assess jurisdiction-specific merger control and licensing constraints.",
  ],
};
